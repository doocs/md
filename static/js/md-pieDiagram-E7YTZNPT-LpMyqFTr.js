import{t as e}from"./md-ordinal-D4BAXFQA.js";import"./md-src-CgtiL2qV.js";import{t}from"./md-chunk-X3CZISLH-BPl9t-jR.js";import{t as n}from"./md-arc-D1Wt2YdB.js";import{t as r}from"./md-pie-HleD2pMJ.js";import{i,p as a}from"./md-chunk-75Z2AOVW-BBX7s6bU.js";import{n as o}from"./md-mermaid-parser.core-BkDGpWtk.js";import{n as s}from"./md-chunk-Y2CYZVJY-DsF7k-Jl.js";import{H as c,K as l,U as u,a as d,c as f,f as p,v as m,w as h,x as g,y as _}from"./md-chunk-DU6HZSFF-55azQaV2.js";import{t as v}from"./md-chunk-JWPE2WC7-qo9X49S-.js";import{f as y}from"./md-mermaid.core-CXG4ZAya.js";var b=p.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:s(()=>structuredClone(w),`getConfig`),clear:s(()=>{S=new Map,C=x.showData,d()},`clear`),setDiagramTitle:l,getDiagramTitle:h,setAccTitle:u,getAccTitle:_,setAccDescription:c,getAccDescription:m,addSection:s(({label:e,value:n})=>{if(n<0)throw Error(`"${e}" has invalid value: ${n}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,n),t.debug(`added new section: ${e}, with value: ${n}`))},`addSection`),getSections:s(()=>S,`getSections`),setShowData:s(e=>{C=e},`setShowData`),getShowData:s(()=>C,`getShowData`)},E=s((e,t)=>{v(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:s(async e=>{let n=await o(`pie`,e);t.debug(n),E(n,T)},`parse`)},O=s(e=>`
  .pieCircle{
