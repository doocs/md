      ...
      <div class="grid min-w-0 flex-1 grid-cols-[1fr_auto] items-center gap-0.5">
        ...
        <template v-if="showReplace">
          <textarea
            ...
            class="mt-0.5 min-w-0 rounded-md border border-input bg-background px-3 py-[7px] text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 resize-none leading-none overflow-y-auto max-h-[150px]"
