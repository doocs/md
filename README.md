...
| 7   | [Minio](https://min.io/) | 配置 `Endpoint`、`Port`、`UseSSL`、`Bucket`、`AccessKey`、`SecretKey` 参数 | [如何使Minio?](http://docs.minio.org.cn/docs/master/minio-client-complete-guide)  Port如果是默认的80或443，请保持0              |
